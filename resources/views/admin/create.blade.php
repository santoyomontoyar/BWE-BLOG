                ...
                <div id="language-es" class="language-panel space-y-6">
                    ...
                    <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
                        ...
                        <textarea
                            ...
                            placeholder="Empieza a redactar el contenido de tu entrada aquí...">{{ old('content') }}</textarea>
                    ...
                    <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 space-y-5">
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-300 resize-none">{{ old('seo_description') }}</textarea>
                ...
                <div
                    ...
                    <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
                        ...
                        <textarea
                            ...
                            rows="16"
                            class="tinymce-editor w-full"
                            placeholder="Write the content here...">{{ old('content_en') }}</textarea>
                    ...
                    <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 space-y-5">
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-300 resize-none">{{ old('seo_description_en') }}</textarea>
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
                    ...
                    <div id="excerpt-es">
                        ...
                        <textarea
                            ...
                            class="w-full border border-gray-200 rounded-xl p-3 text-sm focus:outline-none focus:ring-2 focus:ring-blue-300 resize-none">{{ old('excerpt') }}</textarea>
                    ...
                    <div id="excerpt-en" class="hidden">
                        ...
                        <textarea
                            ...
                            class="w-full border border-gray-200 rounded-xl p-3 text-sm focus:outline-none focus:ring-2 focus:ring-blue-300 resize-none">{{ old('excerpt_en') }}</textarea>
